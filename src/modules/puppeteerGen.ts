...
export interface ScenarioStep { type: string; selector?: string; value?: string; waitFor?: string; }
...
const stepSchema = z.object({
	type: z.enum(["click", "fill", "waitFor"] as any),
...
export class PuppeteerGenerator {
	...
	private buildTemplate(visual: boolean) {
		return (scenario: Scenario, pages: string[]) => `// GENERATED BY MDT — REVIEW
