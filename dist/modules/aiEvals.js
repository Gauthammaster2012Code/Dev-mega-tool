...
export class QwenProvider {
    name = "qwen";
    clientPromise;
    constructor(apiKey, model = "qwen2.5-coder-32b-instruct", baseURL = "https://dashscope.aliyuncs.com/compatible-mode/v1") {
        this.clientPromise = import("openai").then((m) => new m.OpenAI({ apiKey, baseURL }));
        this.model = model;
    }
    model;
...
export class DeepSeekProvider {
    name = "deepseek";
    clientPromise;
    constructor(apiKey, model = "deepseek-coder", baseURL = "https://api.deepseek.com/v1") {
        this.clientPromise = import("openai").then((m) => new m.OpenAI({ apiKey, baseURL }));
        this.model = model;
    }
    model;
